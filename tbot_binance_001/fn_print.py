...
def fn_print_current_status (datetime_start, balance_start_token_1_float, balance_current_token_1_float, balance_locked_token_1,
    ...
    #balance_current_token_1_float = float(balance_current_token_1_float['free'])
    #balance_start_token_2_float = float(balance_start_token_2_float['free'])
    #balance_current_token_2_float = float(balance_current_token_2_float['free'])
    ...
    print(Fore.GREEN + \
          '================ ИНДИКАТОРЫ ================\n', \
          'TimeLine раб.области          :', input_var.INTERVAL, '\n',\
          'RSI Limit                     :', input_var.RSI_LIMIT, '\n',\
